    ...
    def send_vulnerability_alert(self, scan_data: Dict) -> bool:
        ...
        try:
            ...
            html_body = render_template(
                "emails/vulnerability_alert.html",
                emoji=emoji,
                severity=severity,
...
"""
    ...
    def send_scan_failure_notification(self, scan_data: Dict) -> bool:
        ...
        try:
            ...
            html_body = render_template(
                "emails/scan_failure.html",
                image_name=image_name,
                image_tag=image_tag,
                status=status,
                scanner_type=scanner_type,
                scan_timestamp=scan_data.get(
...
def create_email_service(
    ...
    password: str,
    recipients: List[str],
) -> Optional[EmailNotificationService]:
