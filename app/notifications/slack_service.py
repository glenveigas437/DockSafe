...
class SlackNotificationService:
    ...
    def send_message(self, message: str, blocks: List[Dict] = None, **kwargs) -> bool:
        ...
        """
        try:
            payload = {"text": message, "channel": self.channel}
    ...
    def send_vulnerability_alert(self, scan_data: Dict) -> bool:
        ...
        try:
            ...
            return self.send_message(message=fallback_text, blocks=blocks, color=color)
    ...
    def send_scan_completion_notification(self, scan_data: Dict) -> bool:
        ...
        try:
            ...
            return self.send_message(message=message, blocks=blocks, color=color)
    ...
    def send_test_message(self) -> bool:
        ...
        try:
            ...
            return self.send_message(message=test_message, blocks=blocks, color="good")
...
def create_slack_service(
    webhook_url: str, channel: str = None
