...
class ErrorMessages:
    ...
    GOOGLE_OAUTH_NOT_AVAILABLE = (
        "Google OAuth is not available. Please contact your administrator."
    )
    EMAIL_NOT_VERIFIED = (
        "Email address not verified by Google. Please verify your email and try again."
    )
    ACCOUNT_DEACTIVATED = (
    ...
    IMAGE_NOT_FOUND = (
        "Image not found. Please check if the image exists and is accessible."
    )
...
class SuccessMessages:
    ...
    NOTIFICATION_CONFIGURATIONS_REFRESHED = (
        "Notification configurations refreshed successfully"
    )
