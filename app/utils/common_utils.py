...
class LoggingUtils:
    ...
    @staticmethod
    def log_scan_event(logger: logging.Logger, event: str, image_name: str, 
                      image_tag: str, user_id: Optional[int] = None, **kwargs):
        log_data = {
            'event': event,
...
class ErrorHandlingUtils:
    @staticmethod
    def handle_database_error(error: Exception, logger: logging.Logger) -> Dict[str, Any]:
    ...
    @staticmethod
    def handle_validation_error(error: Exception, logger: logging.Logger) -> Dict[str, Any]:
    ...
    @staticmethod
    def handle_permission_error(error: Exception, logger: logging.Logger) -> Dict[str, Any]:
