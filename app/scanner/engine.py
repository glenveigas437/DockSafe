...
class ScanResult:
    ...
    def critical_count(self) -> int:
        return len(
            [v for v in self.vulnerabilities if v.severity.upper() == "CRITICAL"]
        )
...
class VulnerabilityScanner(ABC):
    ...
    def __init__(
        self, scanner_type: str = "trivy", config: Optional[Dict[str, Any]] = None
    ):
    ...
    def should_fail_build(
        self, scan_result: ScanResult, threshold: str = "HIGH"
    ) -> bool:
