...
class NotificationMapper:
    @staticmethod
    def create_configuration(name, type, service, group_id, webhook_url=None, 
                           channel=None, subject_template=None, notify_critical=True,
                           notify_high=True, notify_medium=False, notify_low=False,
                           notify_scan_failed=True, notify_daily_summary=False,
    ...
    @staticmethod
    def create_notification_history(scan_id, group_id, notification_type, recipient, 
                                  message_content, status='SENT', error_message=None,
    ...
    def get_notification_history(group_id, limit=50):
        return NotificationHistory.query.filter_by(
            group_id=group_id
